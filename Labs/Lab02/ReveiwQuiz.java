...
public class ReveiwQuiz extends Application {
	...
	//top [add Font size 8, 10, 12, and 14.]
	...
	public void setUI(){
		...
		hBox[0].getChildren().addAll(new Label("Select Font Style"), comboBox, comboBox2, new Label("Select Font Size"));
		comboBox.getItems().addAll(Font.getFamilies());
		comboBox.setOnAction(this::setFont);
		//implement font size combobox
		comboBox2.getItems().addAll("8", "10", "12", "14");
